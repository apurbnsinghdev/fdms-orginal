...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Requisition Edit</b></h4>
        ...
        <div class="panel">
            <div class="panel-content">
			    {{ Form::model($requisitions,array('route' => array('requisitions.update',$requisitions->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                    ...
                    <div id="comment-wraper" class="form-group{{ $errors->has('comment') ? ' has-error' : '' }}">
					...
					<div class="form-group">
						...
						<div class="col-md-6 pt-sm">
			                 <strong>{!! $requisitions->shop->outlet_name??'' !!} :: {{ $requisitions->shop->mobile??'' }}</strong>
						</div>
					</div>
